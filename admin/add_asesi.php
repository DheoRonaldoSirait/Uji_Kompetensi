...
<head>
    ...
    <title>Tambah Asesi - Admin</title>
    <!-- Favicon -->
...
<body style="background-color: #ECEEEE;">
    ...
    require_once 'add_asesi_data.php';
    ?>
    ...
    <div class="container shadow-lg bg-light navbar-light rounded-3  animated animatedFadeInUp fadeInUp" style="background-color: white; padding: 30px; margin-bottom: 30px;">
        ...
        <form method="POST">
            <div class="mb-3">
                ...
                <input maxlength="8" type="text" class="form-control" id="nik" placeholder="Isi NIK Asesi" name="nik" required>
            </div>
            <div class="mb-3 mt-3">
                <label for="nama" class="form-label">Nama Asesi</label>
                <input type="text" class="form-control" id="nama" placeholder="Isi Nama Asesi" name="nama" required>
            </div>
            <div class="mb-3">
            ...
            <button type="submit" href="index.php" class="btn btn-success" name="btn1" id="btn1">Submit</button>
