...
?>
        ...
        <head>
            ...
            <title>Uji Kompetensi - DPW</title>
        ...
        <body class="w3-light-grey">
            ...
            <div class="w3-content w3-white w3-padding w3-card w3-round" style="max-width: 800px; margin: 45px auto;">
                ...
                <div class="w3-margin">
                    ...
                    <h2>Daftar Pertanyaan Wawancara untuk <?= $row['nama']; ?></h2>

                    <form action="valid_dpw.php" method="post" id="frm1">
                        ...
                        <table class="w3-table-all">
                            ...
                            $sql = "SELECT * FROM uji_soal_dpw WHERE $fundamental ";
